...
export default function BeerCard({ name, brewery, description, origin, style, abv, ibv, author, createdAt } : Props) {
	const orgdate = createdAt
	const newdate = new Date(Date.parse(orgdate))
	const finaledate = newdate.toDateString()
	return (
		<Link href={`/beers/${encodeURIComponent(name)}`}>
			<div className="bg-white rounded-lg shadow-lg">
				...
				<div className="p-6">
					<div>
						<h2 className="font-bold mb-2 text-2xl text-purple-800">Beer Name</h2>
